          ...
          <h1 className={`${marckScript.className} pl-8 text-white text-2xl underline underline-offset-[7px]`}>
            {
              ...
              <Link className='flex gap-2 items-center' href="/"> 
                <div className='w-[40px] h-[40px] relative rounded-full overflow-hidden border-white border-2'>
                  <Image alt="portrait de Estelle Bétry, psychomotricienne" src="https://res.cloudinary.com/danelectrocloudname/image/upload/v1783024662/1editsize_ryc1ep.jpg" fill style={{objectFit: 'cover'}}/>
                </div> 
                Estelle Bétry
              </Link>
              :
              <div className='w-[50px] h-[50px] relative rounded-full overflow-hidden border-white border-2'>
                <Link href="/"><Image alt="portrait de Estelle Bétry, psychomotricienne" src="https://res.cloudinary.com/danelectrocloudname/image/upload/v1783024662/1editsize_ryc1ep.jpg" fill style={{objectFit: 'cover'}}/></Link>
              </div>
            }
